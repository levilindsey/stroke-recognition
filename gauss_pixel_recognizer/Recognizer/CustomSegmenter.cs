...
namespace StrokeCollector
{
	class CustomSegmenter
	{
		...
		/// </summary>
		private static int PostProcess(DrawablePoint[] points)
		{
		...
		/// removed.
		/// </summary>
		private static int RemoveCloseIndexPoints(DrawablePoint[] points)
		{
		...
		/// </summary>
		private static int RemoveCloseArcLengthPoints(DrawablePoint[] points)
		{
			int featurePointCount = 2;
			int seqStartIndex = 0;
			int seqEndIndex = points.Length - 1;
