...
namespace StrokeCollector
{
	...
	class Params
	{
		...
		public const short
			...
			CONFUSION_MATRIX_THRESHOLD_DIAGONAL_1		= 9,
			CONFUSION_MATRIX_THRESHOLD_DIAGONAL_2		= 6,
			CONFUSION_MATRIX_THRESHOLD_OFF_DIAGONAL_1	= 1,
			CONFUSION_MATRIX_THRESHOLD_OFF_DIAGONAL_2	= 3,

			END_POINT_THROW_AWAY_COUNT			= 0
			;
		...
		public const double
			...
			GAUSSIAN_SIDE_PLUS_CENTER_RATIO		= GAUSSIAN_SIDE_RATIO + GAUSSIAN_CENTER_RATIO,

			GAUSSIAN_2D_BIG_RATIO				= GAUSSIAN_CENTER_RATIO * GAUSSIAN_CENTER_RATIO,
			GAUSSIAN_2D_MEDIUM_RATIO			= GAUSSIAN_CENTER_RATIO * GAUSSIAN_SIDE_RATIO,
			GAUSSIAN_2D_SMALL_RATIO				= GAUSSIAN_SIDE_RATIO * GAUSSIAN_SIDE_RATIO,
			...
			BITMAP_GRID_THICKNESS				= 2.0,		// in pixels
		...
		public static Color
			...
			BITMAP_GRID_COLOR					= Color.FromArgb(255, 8, 0, 68),
		...
		public static SolidColorBrush
			...
			BITMAP_GRID_BRUSH					= new SolidColorBrush(BITMAP_GRID_COLOR),
