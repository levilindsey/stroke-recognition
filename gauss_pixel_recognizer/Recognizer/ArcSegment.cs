...
namespace StrokeCollector
{
	class ArcSegment : Segment
	{
		...
		protected override void CreateShape()
		{
			...
			startAngle = this.startAngle + Params.TWO_PI;
			endAngle = this.endAngle + Params.TWO_PI;
			...
			double numberOfLineSegments = Params.TWO_PI * radius / Params.ARC_SEGMENT_POINT_SPACING;
		...
		{
			get { return StrokePreProcessing.GetAngleSpread(startAngle, endAngle, isCW); }
		}
