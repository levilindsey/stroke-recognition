...
namespace StrokeCollector
{
	class ShortStrawSegmenter
	{
		...
		/// </summary>
		private static void BottomUp(DrawablePoint[] points, double shortStrawThreshold)
		{
		...
		/// </summary>
		private static int TopDown(DrawablePoint[] points)
		{
		...
		/// </summary>
		private static void AddPointsToFormLines(DrawablePoint[] points, int startIndex, int endIndex)
		{
		...
		/// collinear.
		/// </summary>
		private static int RemovePointsFromCollinearTriplets(DrawablePoint[] points)
		{
		...
		/// </summary>
		private static bool IsLine(DrawablePoint a, DrawablePoint b)
		{
		...
		/// </summary>
		private static int HalfWayCorner(DrawablePoint[] points, int startIndex, int endIndex)
		{
