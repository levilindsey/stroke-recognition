...
namespace StrokeCollector
{
	class Point : Drawable
	{
		...
		/// Constructor.
		/// </summary>
		public Point(System.Windows.Point point, double timestamp)
		{
		...
		public static Point ParseStringToPoint(String[] tokens)
		{
		...
		public static Point[] DeepCopy(IEnumerable<Point> oldPoints)
		{
			Point[] newPoints = new Point[oldPoints.Count()];
			int i = 0;

			foreach (Point oldPoint in oldPoints)
			{
				newPoints[i++] = new Point(oldPoint);
			}
