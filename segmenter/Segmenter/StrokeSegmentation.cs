...
namespace StrokeCollector
{
	class StrokeSegmentation
	{
		...
		/// </summary>
		public static Segment[] FitSegments(Point[] points,
		...
		/// of points.
		/// </summary>
		public static LineSegment FitALine(Point[] points, int startIndex, int endIndex)
		{
			...
			double errorOfFit = ComputeLineErrorOfFit(points, startIndex, endIndex, a[0], a[1], 
				isHorizontal);
			Point startPoint = FindLineSegmentEnd(points[startIndex], a[0], a[1], isHorizontal);
			Point endPoint = FindLineSegmentEnd(points[endIndex], a[0], a[1], isHorizontal);
		...
		/// 
		/// </summary>
		public static Point FindLineSegmentEnd(Point point, double A, double B, bool isHorizontal)
		{
			// The fit line
			double A1, B1, C1;
		...
		/// </summary>
		public static Matrix<double> GetLineMatrixA(Point[] points, int startIndex, int endIndex, 
			bool isHorizontal)
		{
			double
				M_11 = 0,
		...
		/// (From eqn 8 in Speed Seg paper)
		/// </summary>
		public static Vector<double> GetLineVectorB(Point[] points, int startIndex, int endIndex, 
			bool isHorizontal)
		{
			double
				b_1 = 0,
		...
		/// of points.
		/// </summary>
		public static ArcSegment FitACircle(Point[] points, int startIndex, int endIndex)
		{
			...
			double startAngle = StrokePreProcessing.GetAngle(center, points[startIndex]);
			double endAngle = StrokePreProcessing.GetAngle(center, points[endIndex]);
		...
		/// (From eqn 8 in Speed Seg paper)
		/// </summary>
		public static Matrix<double> GetCircleMatrixA(Point[] points, int startIndex, int endIndex)
		{
			double
				M_11 = 0,
				M_12 = 0,
		...
		/// (From eqn 8 in Speed Seg paper)
		/// </summary>
		public static Vector<double> GetCircleVectorB(Point[] points, int startIndex, int endIndex)
		{
			double
				b_1 = 0,
				b_2 = 0,
		...
		private static double ComputeCircleErrorOfFit(Point[] points, int startIndex,
				int endIndex, Point center, double radius)
		{
			double distance = 0;
		...
		private static double ComputeLineErrorOfFit(Point[] points, int startIndex,
